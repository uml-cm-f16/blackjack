...
class Test_Hand(unittest.TestCase):
    ...
    """
    def test_Hand_strRepresentation(self):
    ...
    def test_Hand_fold(self):
        ...
        # Hand was returned
        self.assertEqual(str(tmpHand[0]), "[AC]")
        self.assertEqual(str(tmpHand[1]), "[2C]")
        self.assertEqual(str(tmpHand[2]), "[3C]")
